...
![](/Hacked-Machines/assets/images/Pasted%20image%2020260407192912.png)
...
![](/Hacked-Machines/assets/images/Pasted%20image%2020260407195122.png)

We add it to `/etc/hosts`:

![](/Hacked-Machines/assets/images/Pasted%20image%2020260407195259.png)

Accessing the site redirects us automatically from http to https, and we can see there isn't much of interest:

![](/Hacked-Machines/assets/images/Pasted%20image%2020260407195411.png)

Directory fuzzing doesn't find anything, so we look for subdomains of `.kobold.htb`:

![](/Hacked-Machines/assets/images/Pasted%20image%2020260407201920.png)

We find two main ones (mcp, bin), but we'll focus on mcp. To reach it we add it to `/etc/hosts`:

![](/Hacked-Machines/assets/images/Pasted%20image%2020260408194840.png)

Now we can visit the page:

![](/Hacked-Machines/assets/images/Pasted%20image%2020260408194658.png)
![](/Hacked-Machines/assets/images/Pasted%20image%2020260407202037.png)
...
![](/Hacked-Machines/assets/images/Pasted%20image%2020260408193625.png)
...
![](/Hacked-Machines/assets/images/Pasted%20image%2020260410104210.png)

Since we landed as the user ben, we create an SSH key pair to get a more usable shell:

![](/Hacked-Machines/assets/images/Pasted%20image%2020260410105519.png)

We connect using the private key we obtained:

![](/Hacked-Machines/assets/images/Pasted%20image%2020260410105427.png)
...
![](/Hacked-Machines/assets/images/Pasted%20image%2020260410174214.png)
